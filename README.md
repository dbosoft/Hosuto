...
To support service bundling it extends the default .NET host framework by capabilities to run multiple host in the same process. In addition the hosts can share common objects like configuration, hosting environment or a shared DI container. 
